...
% Define the System Matrices
 ...
 Cm1=[kc 0 0 0 ;0 0 kc 0]; %Change according to the controller (To control)
 Co1=[0 kc 0 0 ;0 0 0 kc]; %Change according to the observer (To measure)
 Dm1=[0 0;0 0];
...
%For MPC implementation
 ...
 u=zeros(m,1); %u(k-1)=0
 y=zeros(q,1);
 uwt=[4 4]; %input weight R matrix
 ysp=[13.7 2.4];% Set point
 Rs=repmat(ysp',Np,1);
 R=zeros(m*Nc,m*Nc);
 R(1:m,1:m)=diag(uwt);
 for i=2:Nc
